...
model.fit(X_train, Y_train,batch_size=batch_size,nb_epoch=nb_epoch,validation_split=0.3,shuffle=False)
...
with open("/nobackup/leopauly/S2LStage2/logdir_0/audio_classifier_mfcc.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("/nobackup/leopauly/S2LStage2/logdir_0/audio_classifier_mfcc.h5")
